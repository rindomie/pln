  ...
  <tbody>
    ...
    //   die;
      $query = "SELECT *, u.`iduser`,  u.`nik` nikpenemu, u.`nama` penemu, m.`iduser`, m.`nik` nikmoderator,m.`nama` moderator, t.`foto` bukti FROM temuan t 
            ...
            LEFT JOIN unit un ON s.idunit = un.idunit WHERE u.`unit` = $unit AND t.ststemuan = 'diproses'
    ...
    <?php foreach ($cek as $dp) : ?>
      <tr>
          ...
          <?php if ($dp->ststemuan != "diproses") : ?>
            <a href="" data-toggle="modal" data-target="#detail<?= $dp->idtemuan ?>" class="btn btn-primary btn-sm btn-block">Detail</a>
          ...
          <?php else : ?>
            ...
            <a href="" data-toggle="modal" data-target="#acc<?= $dp->idtemuan ?>" class="btn btn-success btn-sm btn-block mb-2">Approve</a>
            <div class="modal fade" id="acc<?= $dp->idtemuan ?>" tabindex="-1" role="dialog" aria-labelledby="addNewDonaturLabel" aria-hidden="true">
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addNewDonaturLabel">Review Temuan <?= $dp->idtemuan;?> </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <?= form_open_multipart('Moderator/ModeratorController/acc/'.$dp->idtemuan); ?>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h6>Approve Temuan</h6>
                                        <div class="form-group">
                                            <label>No. Temuan</label>
                                            <input type="text" class="form-control" id="id" name="id" value="<?= $dp->idtemuan; ?>" placeholder="Nama" required="" readonly>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Moderator</label>
                                            <input type="text" class="form-control" id="inspector" name="inspector" value="<?= $this->session->userdata['nik'].'-'.$this->session->userdata['nama']; ?>" placeholder="Nama" required="" readonly>
                                            <input type="text" class="form-control" id="moderator" name="moderator" value="<?= $this->session->userdata['id']?>" hidden readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Tanggapan</label>
                                            <textarea type="text" rows="3" class="form-control" id="tanggapn" name="tanggapan" value="" placeholder="" required="" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Department</label>
                                            <select name="dept" id="dept" class="form-control" required>
                                                ...
                                                <option value="Keselamata">Keselamatan</option>
                                                <option value="Pelayanan">Pelayanan</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Deadline</label>
                                            <input type="date" class="form-control" id="deadline" name="deadline" value="" placeholder="" required="">
                                        </div> 
                                    </div>
                                </div>
                            </div>
            ...
            <a href="" data-toggle="modal" data-target="#tolak<?= $dp->idtemuan ?>" class="btn btn-danger btn-sm btn-block mb-2">Reject</a>
            <div class="modal fade" id="tolak<?= $dp->idtemuan ?>" tabindex="-1" role="dialog" aria-labelledby="addNewDonaturLabel" aria-hidden="true">
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addNewDonaturLabel">Review Temuan <?= $dp->idtemuan;?> </h5>
                        ...
                        <?= form_open_multipart('Moderator/ModeratorController/tolak/'.$dp->idtemuan); ?>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h6>Reject Temuan</h6>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" rows="3" style="height: 120px" class="form-control" id="tanggapn" name="tanggapan" value="" placeholder="" required=""></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
