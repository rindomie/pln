...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <a href="<?= base_url('Temuan/TemuanController/DaftarTemuan') ?>" class="btn btn-dark mb-3"><i class="fas fa-arrow-left"></i> Kembali</a>
  ...
  <div class="row ">
    <div class="col-lg-6">
     ...
     <?= form_open_multipart('Temuan/TemuanController'); ?>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="id" name="id" value="<?= $user['iduser']?>" readonly hidden> 
    </div>
    ...
    <div class="form-group">
      ...
      <textarea type="text" class="form-control" rows="1" id="lokasi" placeholder="Masukkan Lokasi Temuan" name="lokasi" value=""></textarea>
    </div>

    <div class="form-group">
      <label for="nama">Keterangan</label>
      <textarea class="form-control" rows="3" style="height: 100px;" id="keterangan" placeholder="Masukkan Keterangan" name="keterangan" ></textarea>
    </div>
 ...
 <div class="col-lg-6">
     ...
     <div class="form-group">
      ...
      <input type="date" class="form-control" id="tgltemu" placeholder="Masukkan Nama" name="tgltemu" value="<?= date('Y-m-d')?>">
    </div>
