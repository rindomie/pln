    ...
    <?php foreach ($cek as $dp) : ?>
      <tr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" rows="3" class="form-control" id="tanggapn" name="tanggapan" value="" placeholder="Nama" required="" readonly><?= $dp->tanggapan; ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Department</label>
                                            <input type="text" class="form-control" id="dept" name="dept" value="<?= $dp->pjdept; ?>" placeholder="Nama" required="" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Deadline</label>
                                            <input type="text" class="form-control" id="deadline" name="deadline" value="<?= $dp->deadline; ?>" placeholder="Nama" required="" readonly>
                                        </div>
          ...
          <?php else : ?>
            ...
            <!-- <a href="<?= base_url('Admin/UserController/edit/'.$dp->iduser) ?>" class="btn btn-info btn-sm btn-block">Edit</a> -->
            <a href="" data-toggle="modal" data-target="#edit<?= $dp->idtemuan ?>" class="btn btn-info btn-sm btn-block mb-2">Edit</a>
            <div class="modal fade" id="edit<?= $dp->idtemuan ?>" tabindex="-1" role="dialog" aria-labelledby="addNewDonaturLabel" aria-hidden="true">
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addNewDonaturLabel">Edit Temuan <?= $dp->idtemuan;?> </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <?= form_open_multipart('Temuan/TemuanController/edit/'.$dp->idtemuan); ?>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h6>Edit Temuan</h6>
                                        ...
                                        <div class="form-group">
                                            <label>Nama Temuan</label>
                                            <input type="text" class="form-control" id="title" name="title" value="<?= $dp->title; ?>" placeholder="Nama" required="">
                                        </div>
                                        <div class="form-group">
                                            <label>Keterangan</label>
                                            <textarea type="text" rows="3" class="form-control" id="ket" name="ket" value="" placeholder="Nama" required=""><?= $dp->keterangan; ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama">Kategori Temuan</label>
                                            <select name="kategori" id="kategori" class="form-control" >
                                                <option value="<?= $dp->tipetemuan; ?>" selected hidden><?= $dp->tipetemuan; ?></option>
                                        ...
                                        <div class="form-group">
                                            <label>Lokasi Temuan</label>
                                            <input type="text" class="form-control" id="lokasi" name="lokasi" value="<?= $dp->lokasi; ?>" placeholder="Nama" required="">
                                        </div>
                                        <div class="form-group">
                                            <label>Status Temuan</label>
                                            <input type="text" class="form-control" id="ststemuan" name="ststemuan" value="<?= $dp->ststemuan; ?>" placeholder="Nama" required="" readonly>
            ...
            <!-- <a href="<?= base_url('Admin/UserController/delete/'.$dp->iduser) ?>" class="btn btn-warning btn-sm btn-block">Hapus</a> -->
          <?php endif; ?>
          <!-- <?= $dp->status;?> -->
          </td>
        <td><?= $dp->nikpenemu; ?></td>
